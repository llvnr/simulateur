...
class EtapeVitrineC extends Component {
...
handleSubmit = (e) => {
    ...
    localStorage.setItem('prevEtape', 'Etape-vitrine-B')
            ...
            <div className="container mt-2">
                ...
                <div style={{ marginTop: '10%', marginBottom: '10%' }}>
                    ...
                    <div className="mt-5">
                        ...
                        <div className="mb-3">
                        <label className="form-label text-dark" style={{ color: '#DADADA' }}>Si oui, remplissez le champ suivant avec le nom des plugins qui vous intéresse ou si vous ne savez pas décrivez au mieux ce que doit faire les plugins : </label>
                        ...
                        <div className="mb-3">
                        <label className="form-label text-dark" style={{ color: '#DADADA' }}>Si oui, collez les liens qui peuvent nous aider : </label>
...
export default withRouter(EtapeVitrineC);